...
const enUS: typeof zhCN = {
  ...
  tool: {
    ...
    pdf: {
      ...
      split: { name: "Organize pages", desc: "Uncheck pages you don't want on a thumbnail grid, drag to reorder, rotate any page, then export a new PDF. Split, extract and delete-pages all live here." },
  ...
  err: {
    ...
    pdfTooManyPages: "This PDF has a lot of pages; the visual organizer handles up to {max}. For very long files, use Split instead.",
